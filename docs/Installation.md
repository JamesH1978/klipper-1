...
KIAUH is script based and can be installed by the following commands in the Linux
terminal:
...
One can then proceed to access the Install menu and install the parts needs to make
up your Klipper build.
